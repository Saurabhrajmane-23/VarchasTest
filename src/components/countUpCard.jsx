...
const CountUpCard = ({end=100,start=0,name="Colleges",duration=5,suffix}) => {
    ...
    return (
        ...
        <div className="h-full md:h-2/3 w-1/4 bg-black flex flex-col border-4 border-yellow-400 rounded-[10px] transition-all transform hover:scale-105 hover:shadow-2xl hover:border-yellow-500 hover:bg-yellow-500">
